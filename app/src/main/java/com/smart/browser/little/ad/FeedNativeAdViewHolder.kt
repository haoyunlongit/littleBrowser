...
import com.smart.browser.little.databinding.AdNativeFeedBinding
...
class FeedNativeAdViewHolder(val binding: AdNativeFeedBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    companion object {
        fun from(parent: ViewGroup): FeedNativeAdViewHolder {
            val layoutInflater = LayoutInflater.from(parent.context)
            val binding = AdNativeFeedBinding.inflate(layoutInflater, parent, false)
            return FeedNativeAdViewHolder(binding)
        }
    }
}